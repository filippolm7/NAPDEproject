...
for i = 1:size(region.coords_element,2)
    X = [];
    Y = [];
    for j = 1:size(region.connectivity{i},2)
%         disp([i,j,neighbour.neigh{i}(j)]);
        
        %interface edges
%         if neighbour.neigh{i}(j) > 0 && region.id(neighbour.neigh{i}(j)) == 3 && region.id(i) == 1
%             if j < size(region.connectivity{i},2)
...
%             elseif j == size(region.connectivity{i},2)
%                 plot([region.coords_element{i}(size(region.connectivity{i},1),2),region.coords_element{i}(1,1)],...
...
%         end       
        ...
        if neighbour.neigh{i}(j) == -4
            ...
            elseif j == size(region.connectivity{i},2)
                plot([region.coords_element{i}(size(region.connectivity{i},2),1),region.coords_element{i}(1,1)],...
                    [region.coords_element{i}(size(region.connectivity{i},2),2),region.coords_element{i}(1,2)],'Color','m','LineWidth',1.5)
            end
        end
        % Absorbing
        if neighbour.neigh{i}(j) == -3
            ...
            elseif j == size(region.connectivity{i},2)
                plot([region.coords_element{i}(size(region.connectivity{i},2),1),region.coords_element{i}(1,1)],...
                    [region.coords_element{i}(size(region.connectivity{i},2),2),region.coords_element{i}(1,2)],'Color','g','LineWidth',1.5)
            end
        end
        % Neumann
        if neighbour.neigh{i}(j) == -2
            ...
            elseif j == size(region.connectivity{i},2)
                plot([region.coords_element{i}(size(region.connectivity{i},2),1),region.coords_element{i}(1,1)],...
                    [region.coords_element{i}(size(region.connectivity{i},2),2),region.coords_element{i}(1,2)],'Color','r','LineWidth',1.5)
            end
        end
        % Dirichlet
        if neighbour.neigh{i}(j) == -1
            ...
            elseif j == size(region.connectivity{i},2)
                plot([region.coords_element{i}(size(region.connectivity{i},2),1),region.coords_element{i}(1,1)],...
                    [region.coords_element{i}(size(region.connectivity{i},2),2),region.coords_element{i}(1,2)],'Color','b','LineWidth',1.5)
            end
        end
    end
end
